...
{
	$table2->addRow();
    $RetCourse = $bdd->query("select Name, Semester, ECTS, IdC from course where IdC in(select IdC from choose where IdChoose like '".$_POST['item'.$i]."' )");
...
// Adding Text element to the Section having font styled by default...
$section->addText(
    'During the mobility', $TitlefontStyle
);
...
$objWriter->save('Preview/helloWorld.html');

header('Location:Preview/helloWorld.html');